...
soundManager.onready(function() {
    $log.debug('song manager ready!');
            ...
            addToPlaylist: function(track) {
                playlist.push(track);
                //Storing playlist array as a string
                localStorage.setItem("PlayListArray", JSON.stringify(playlist));
                ...
                element.bind('click', function(event) {
                    ...
                    angularPlayer.clearPlaylist(function(data) {
                        ...
                        //add songs to playlist
                          ...
                          if (playlistToArray !== null){
                           for(var i = 0; i < playlistToArray.length; i++) {
                            angularPlayer.addTrack(playlistToArray[i]);
                        }
                    }
